...
// training
constexpr size_t TRAIN_BS = 16;
constexpr size_t TRAVERSAL_BS = 16;
constexpr size_t TRAIN_EPOCHS = 1;
constexpr size_t TRAIN_ITERS = 10;
