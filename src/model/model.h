...
extern void* create_deep_cfr_model(int64_t n_players, int64_t n_bets, int64_t n_actions, int64_t dim = 256);
extern torch::Tensor deep_cfr_model_forward(void* model_ptr, std::array<torch::Tensor, 4> cards, torch::Tensor bet_fracs, torch::Tensor bet_status);
extern void delete_deep_cfr_model(void* model_ptr);
extern void set_model_eval_mode(void* model_ptr); // If implemented
extern int64_t get_action_head_dim(void* model_ptr);
